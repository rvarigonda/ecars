...
function templateTransform(src, filename, options) {
    const { experimentalDynamicComponent, preserveHtmlComments, enableStaticContentOptimization, customRendererConfig, enableLwcSpread, enableScopedSlots, } = options;

...
export declare function externalComponent(parse5Elm: parse5.Element, parse5ElmLocation: parse5.ElementLocation): ExternalComponent;
...
export declare function scopedSlotFragment(identifier: Identifier, elementLocation: SourceLocation, directiveLocation: SourceLocation, slotName: Literal): ScopedSlotFragment;

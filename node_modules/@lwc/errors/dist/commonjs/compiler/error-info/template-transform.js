...
exports.ParserDiagnostics = {
    ...
    INVALID_OPTS_LWC_SLOT_BIND: {
        code: 1167,
        message: 'Invalid lwc:slot-bind usage. The "Scoped Slots" feature must be enabled in order to use this directive.',
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
    INVALID_OPTS_LWC_SLOT_DATA: {
        code: 1168,
        message: 'Invalid lwc:slot-data usage. The "Scoped Slots" feature must be enabled in order to use this directive.',
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
